...
type ENV_CONFIGS struct {
	...
	GIN_MODE                           string
	DISABLE_COLOR                      bool
	POSTGRES_TRIGGER_USE_CDN           string
	POSTGRES_TRIGGER_FROM_CDN_URL      string
	POSTGRES_TRIGGER_FROM_CDN_FILEPATH string
}
...
func InitEnv() {
	EnvConfigs = ENV_CONFIGS{
		...
		POSTGRES_TRIGGER_USE_CDN:           os.Getenv("POSTGRES_TRIGGER_USE_CDN"),
		POSTGRES_TRIGGER_FROM_CDN_URL:      os.Getenv("POSTGRES_TRIGGER_FROM_CDN_URL"),
		POSTGRES_TRIGGER_FROM_CDN_FILEPATH: os.Getenv("POSTGRES_TRIGGER_FROM_CDN_FILEPATH"),
	}
